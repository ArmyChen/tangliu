    ...
    function get_code($order, $payment)
    {
        ...
        if($openid)
        {
            ...
            if($allow_use_wxPay)
            {
               ...
               $html .= "function(res){";
                $html .= "if(res.err_msg == 'get_brand_wcpay_request:ok'){window.location.href='".$GLOBALS['ecs']->url()."respond.php?code=wx_new_jspay&order_id=".$order['order_sn']."'}";
            ...
            $html .= '</script>';
            $html .= '<button   type="button"  class="c-btn3"  onclick="callpay()">微信支付</button>';
