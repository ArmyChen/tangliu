...
$_LANG['booking_js']['email_empty'] = '请输入联系人的邮件地址！';
$_LANG['booking_js']['email_error'] = '您输入的邮件地址格式不正确！';
...
$_LANG['edit_email_failed'] = '编辑邮件地址失败！';
...
$_LANG['profile_js']['email_empty'] = '请输入您的邮件地址！';
$_LANG['profile_js']['email_error'] = '您输入的邮件地址格式不正确！';
...
/* 会员密码找回 */
$_LANG['username_and_email'] = '请输入您注册的用户名和注册时填写的邮件地址。';
$_LANG['enter_new_password'] = '请输入您的新密码';
$_LANG['username_no_email'] = '您填写的用户名与邮件地址不匹配，请重新输入！';
...
$_LANG['username_not_match_email'] = '用户名与邮件地址不匹配，请重新输入！';
...
$_LANG['password_js']['email_address_empty'] = '请输入您的邮件地址！';
$_LANG['password_js']['email_address_error'] = '您输入的邮件地址格式不正确！';
