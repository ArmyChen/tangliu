...
if ($_REQUEST['act'] == 'list') {
    ...
    $modules = read_modules('../m/includes/modules/payment');
    ...
    include_once (ROOT_PATH . 'm/includes/lib_compositor.php');
    assign_query_info();
    ...
    admin_priv('payment');
    $set_modules = true;
    include_once (ROOT_PATH . 'm/includes/modules/payment/' . $_REQUEST['code'] . '.php');
    $data = $modules[0];
    ...
    $code = $_REQUEST['code'];
    $set_modules = true;
    include_once (ROOT_PATH . 'm/includes/modules/payment/' . $code . '.php');
