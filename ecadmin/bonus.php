...
if ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('ur_here',      "红包列表");
    $smarty->assign('action_link',  array('href' => 'bonus.php?act=list', 'text' => "红包列表"));
...
if ($_REQUEST['act'] == 'edit')
{
    ...
    $smarty->assign('lang',        $_LANG);
    $smarty->assign('ur_here',     "编辑红包");
    $smarty->assign('action_link', array('href' => 'bonus.php?act=list&' . list_link_postfix(), 'text' => "红包列表"));
