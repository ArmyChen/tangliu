...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here',     $_LANG['marticlecat_list']);
    $smarty->assign('action_link', array('text' => $_LANG['marticlecat_add'], 'href' => 'articlecat.php?act=add'));
...
elseif ($_REQUEST['act'] == 'add')
{
    ...
    $smarty->assign('ur_here',     $_LANG['marticlecat_add']);
    $smarty->assign('action_link', array('text' => $_LANG['marticlecat_list'], 'href' => 'articlecat.php?act=list'));
...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sql = "INSERT INTO ".$ecs->table('article_cat')."(cat_name, cat_type, cat_desc,keywords, parent_id, sort_order, show_in_nav,title_define,define_url,moban,smallmoban,mmoban,msmallmoban,file_url)
           VALUES ('$_POST[cat_name]', '$cat_type',  '$_POST[cat_desc]','$_POST[keywords]', '$_POST[parent_id]', '$_POST[sort_order]', '$_POST[show_in_nav]', '$_POST[title_define]', '$_POST[define_url]', '$_POST[moban]', '$_POST[smallmoban]', '$_POST[mmoban]', '$_POST[msmallmoban]', '$_POST[file_url]')";
    $db->query($sql);
...
elseif ($_REQUEST['act'] == 'update')
{
    ...
    if ($exc->edit("cat_name = '$_POST[cat_name]', cat_desc ='$_POST[cat_desc]', keywords='$_POST[keywords]',parent_id = '$_POST[parent_id]', cat_type='$cat_type', sort_order='$_POST[sort_order]', show_in_nav = '$_POST[show_in_nav]', title_define = '$_POST[title_define]', define_url = '$_POST[define_url]', moban = '$_POST[moban]', smallmoban = '$_POST[smallmoban]', mmoban = '$_POST[mmoban]', msmallmoban = '$_POST[msmallmoban]', file_url = '$_POST[file_url]'",  $_POST['id']))
    {
...
{
    check_authz_json('article_cat_add');
...
{
    check_authz_json('article_cat_remove');
