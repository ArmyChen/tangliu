...
{
    $smarty->assign('ur_here',     $_LANG['mad_position_mobile']);
    $smarty->assign('action_link', array('text' => $_LANG['mad_position_mobile_add'], 'href' => 'ad_position.php?act=add'));
...
{
    admin_priv('ad_position_mobile');

    /* 模板赋值 */
    $smarty->assign('ur_here',     $_LANG['mad_position_mobile_add']);
    $smarty->assign('form_act',    'insert');

    $smarty->assign('action_link', array('href' => 'ad_position.php?act=list', 'text' => $_LANG['mad_position_mobile']));
...
{
    check_authz_json('ad_position_mobile');
