...
//周五特惠
$order['goods_amount_zhekou']  =price_format((10-$order['zhekou'])*($order['goods_amount']/10));
//周五特惠
...
elseif ($_REQUEST['act'] == 'delivery_ship')
{
    ...
    if ($order_finish)
    {
		...
		//$wxch_order_name = 'order';
			//$w_descriptiontit='您好，您的订单已经安排发货。'."\r\n";
...
/// $wxch_order_name = 'pay';  //czneng
	///   $w_descriptiontit='您好，您的商品已支付成功。'."\r\n";
	///	include(ROOT_PATH . 'admin/wxch_order.php');  //czneng
