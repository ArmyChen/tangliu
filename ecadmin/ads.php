...
include_once(ROOT_PATH . 'includes/cls_image_m.php');
...
if ($_REQUEST['act'] == 'list')
{
    ...
    $smarty->assign('ur_here',     $_LANG['mad_list_mobile']);
    $smarty->assign('action_link', array('text' => $_LANG['mad_list_mobile_add'], 'href' => 'ads.php?act=add'));
...
{
    check_authz_json('ad_list_mobile');
