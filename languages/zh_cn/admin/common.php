...
$_LANG['17_1nms_tbk_api_colect'] = '<font style="color:#0066FF">淘客API采集</font>';
...
/*天猫超市管理*/
$_LANG['02_chaoshi'] = '天猫超市管理';
$_LANG['01_others'] = '<font style="color:#0066FF">常规采集</font>';
$_LANG['02_shop'] = '<font style="color:#0066FF">店铺采集</font>';
$_LANG['03_pach_id'] = '<font style="color:#0066FF">批量ID采集</font>';
$_LANG['04_onekey'] = '<font style="color:#0066FF">按分类采集</font>';
$_LANG['05_setting'] = '<font style="color:#0066FF">采集设置</font>';
$_LANG['taobao'] = '修改';
$_LANG['taobao_data'] = '淘宝数据';
$_LANG['taobao_data_collect'] = '采集完成!';
$_LANG['taobao_data_succed'] = '成功!';
$_LANG['en'] = '英语';
$_LANG['fr-fr'] = '法语';
$_LANG['es-es'] = '西班牙语';
$_LANG['nl-nl'] = '荷兰语';
...
$_LANG['11_user_weixin_config'] = '微信登录设置';
