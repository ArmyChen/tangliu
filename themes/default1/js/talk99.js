(function (D) {
    ...
    }, browser = {strict: doc.compatMode == "CSS1Compat", webkit: /webkit/i.test(ua), msie: /msie/i.test(ua) && !/opera/i.test(ua), gecko: !/webkit/i.test(ua) && /gecko/i.test(ua), safari: /safari/i.test(ua) && !/maxthon/i.test(ua), cacheswf: /theworld|se\s\d+|greenbrowser/i.test(ua)};
    ...
    extend(M.prototype, {defUI: function (mark) {
        ...
        switch (r.c) {
            ...
            case"e":
                var es = r.es;
                for (var v in es) {
                    (typeof es[v] == "object" && es.hasOwnProperty(v)) && this.doEvent(es[v])
                }
                break;
            case"ac":
            case"de":
    ...
    extend(MsgPanel.prototype, (function () {
        ...
        return{builder: function () {
            ...
            var param = {c: E.compId, command: "leaveMessage", g: this.group || "", u: E.uId, v: E.vId, ct: E.counter, site: site, category: 0, _mark: E._mark};
