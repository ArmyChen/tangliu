BizQQWPA.define("wpa.SelectPanel", "lang.browser,util.Style,util.className,util.events,util.offset,util.css,util.proxy,lang.extend", function (c) {
    var b = c("Style"), l = c("className"), d = c("events"), g = c("offset"), i = c("browser"), j = c("css"), m = c("proxy"), k = c("extend");
    var h = 1;
    var a = document;
    var f = function (v, p) {
        var r = function (x, z) {
    ...
    e.prototype = {render: function () {
        ...
        var q = {position: "fixed", marginLeft: "-" + this.outerWidth() / 2 + "px", marginTop: "-" + this.outerHeight() / 2 + "px"};
        ...
        var q = a.createElement("div"), u = {position: "fixed", top: 0, left: 0, zIndex: 2147483647, width: g.getClientWidth() + "px", height: g.getClientHeight() + "px", backgroundColor: "white", opacity: 0.1, filter: "alpha(opacity=10)"};
        var o = a.compatMode === "BackCompat";
        if ((i.msie && parseInt(i.version, 10) < 7) || o) {
            u.position = "absolute";
...
BizQQWPA.define("util.css", "util.contains", function (e) {
    ...
    var c = function (l, j) {
        ...
        var k = {opacity: 0, filter: "alpha(opacity=0)"}, i = l.parentNode, g = l.nextSibling, h = document.createElement("div"), f;
        h.appendChild(l);
        a(h, k);
        a(l, k);
...
BizQQWPA.define("lang.extend", "lang.each,lang.typeEnhance", function (b) {
    ...
    return function () {
        var g = Array.prototype.slice.call(arguments), f = false, d = g.shift(), h = c.type(g[g.length - 1]) === "boolean" ? g.pop() : false;
        if (d === true) {
            f = true;
            d = g.shift()
        }
