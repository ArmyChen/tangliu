    ...
    var r = {cite: 0, img: 1, addto: 2, video: 3}, i = window.location || document.location, s = function () {
        ...
        var e = +(new Date), n = {spendTime: 0, scrollTop: 0, viewHeight: 0}, r = +(new Date), i = function () {
            ...
            if (e > n.spendTime) {
                ...
                n = {spendTime: e, scrollTop: window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop, viewHeight: t.clientHeight}
            }
            r = new Date
        }, o = function (e, t, n) {
        ...
        return function () {
            if (bdShare.velocity && (!bdShare.velocity.mainJsLoaded || !bdShare.velocity.cssLoadEnd) && e++ < 3)setTimeout(p, 1e3); else {
                if (bdShare.velocity) {
                    ...
                    bdShare._LogPool.length > 0 && bdShare._LogPool.push({key: "velo", api: {load: t, cssload: n, jsLoad: r}})
                }
                f()
            }
        }
    }();
    e.ApiPVLogger = {add: function (e, t) {
