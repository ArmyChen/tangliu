(function () {
    var c = {id: "8bab2b92bbc735501427a9f80d5143d7", dm: ["hx1998.com"], etrk: [], js: "tongji.baidu.com/hm-web/js/", icon: '', br: false, ctrk: false, align: -1, nv: -1, vdur: 1800000, age: 31536000000, rec: 0, rp: 0, rs: 0, trust: 0, vcard: 0, se: [
    ...
    (function () {
        ...
        (function () {
            if (!d)if (d = l, "complete" === document.readyState)a.b = l; else if (document.addEventListener)document.addEventListener("DOMContentLoaded",
                f, p), window.addEventListener("load", a, p); else if (document.attachEvent) {
    ...
    oa.prototype = {getData: function (a) {
        ...
        try {
            aa(a, b, {domain: qa(), path: ra(), f: d}), d ? ga(a, b, d) : s(a, b)
        } catch (e) {
        }
    }, k: function (a) {
        if (D(a, "Array")) {
    ...
    function ta() {
        ...
        if (a)for (var a = a.split(","), b = 0, d = a.length; b < d; b++)C(Q + "//" + decodeURIComponent(a[b]).replace(/^https?:\/\//, ""), function (a) {
            S(a)
        })
    }
    ...
    function pa(a) {
        try {
            ...
            a:if (document.referrer) {
                for (var m = 0, ua = c.se.length; m < ua; m++)if (RegExp("(^|\\.)" + c.se[m][1].replace(/\./g, "\\.")).test(A(document.referrer))) {
                    ...
                    if (y || !(2 != c.se[m][0] && 14 != c.se[m][0] && 17 != c.se[m][0])) {
                        ...
                        for (var za = a.a, q = c.se[m], J = 0, Aa = 2 == q[3] ? q[1] + "\\/" : "", Ba = 1 == q[3] ? "\\." +
                            q[1] : "", V = q[4].split(","), q = 0, Ca = V.length; q < Ca; q++)if ("" !== V[q] && RegExp(Aa + V[q] + Ba).test(document.referrer)) {
                            J = q + 1;
                            break
                        }
                        za.sse = J;
            ...
            if (0 == c.nv && T(document.location.href) && ("" == document.referrer || T(document.referrer)))b = 0, d = 4;
            a.a.nv = b;
            a.a.st = d;
            a.a.cc = e;
            a.a.lt = f;
                ...
                switch (B[0]) {
                    ...
                    case "_setAutoPageview":
                        if (1 <
                            B.length) {
                            var $ = B[1];
                            if (p === $ || l === $)a.a.api |= 2, window._bdhm_autoPageview = $
                        }
                }
            }
            if ("undefined" === typeof window._bdhm_account || window._bdhm_account === c.id) {
                ...
                var P = window._hmt;
                if (P && P.length)for (var x = 0, Ga = P.length; x < Ga; x++)a.k(P[x]);
                window._hmt = a.p
            }
            if ("undefined" === typeof window._bdhm_autoPageview || window._bdhm_autoPageview === l)a.h = l, a.a.et = 0, a.a.ep = "", R(a)
        } catch (la) {
    ...
    function sa() {
        var a = "Hm_cv_" + c.id;
        try {
            if (aa(a, "", {domain: qa(), path: ra(), f: -1}), window.sessionStorage && window.sessionStorage.removeItem(a), window.localStorage)window.localStorage.removeItem(a); else if (H())try {
    ...
    function qa() {
        for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)if (U(a, c.dm[b]))return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
        return a
    }
