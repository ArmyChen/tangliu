...
$(function(){
    ...
    box_3 = $('#appraise_box').offset().top - 58;
    box_4 = $('#recommend_box').offset().top - 58;
    goods_detail.nav_scroll(box_1, box_2, box_3, box_4);
